import { Title } from './chunk-ZYMZX4L7.js';
...
import {
  ...
  PlatformNavigation,
  ViewportScroller,
} from './chunk-6X55DICD.js';
import { LOCATION_INITIALIZED, PlatformLocation } from './chunk-UTWBMDNX.js';
import {
...
var NavigationStateManager = class _NavigationStateManager extends StateManager {
  ...
  deferredCommitSupported(event) {
    return (
      this.precommitHandlerSupported && event.cancelable && event.navigationType !== 'traverse'
    );
  }
